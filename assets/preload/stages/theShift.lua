...
function onCreate()
    if songName == 'Wife-Forever' then
        makeLuaSprite("shift", "bg", -388.05 - 130, -202);
        addLuaSprite("shift", false);
        makeLuaSprite("shift2", "bg1", -388.05 - 130, -202);
        ...
        makeLuaSprite("shift", "bg", -388.05 - 130, -202);
        addLuaSprite("shift", false);
        makeLuaSprite("shiftblue", "bgblue", -388.05 - 130, -202);
        addLuaSprite("shiftblue", false);
        setProperty('shiftblue.alpha', 0)
        makeLuaSprite("shiftgreen", "bggreen", -388.05 - 130, -202);
        addLuaSprite("shiftgreen", false);
        setProperty('shiftgreen.alpha', 0)
        makeLuaSprite("shiftred", "bgred", -388.05 - 130, -202);
        addLuaSprite("shiftred", false);
        setProperty('shiftred.alpha', 0)
        makeLuaSprite("shiftpink", "bgpink", -388.05 - 130, -202);
